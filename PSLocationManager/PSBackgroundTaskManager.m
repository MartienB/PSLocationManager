...
@interface PSBackgroundTaskManager()
@property (nonatomic, strong) NSMutableArray *bgTaskIdList;
@property (assign) UIBackgroundTaskIdentifier masterTaskId;
@end

@implementation PSBackgroundTaskManager

+ (instancetype)sharedBackgroundTaskManager {
    static PSBackgroundTaskManager *sharedBGTaskManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedBGTaskManager = [[PSBackgroundTaskManager alloc] init];
    });
